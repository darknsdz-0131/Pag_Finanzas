...
export const StatsSection = () => {
  ...
  return (
    <section id='stats' className='section-padding bg-foreground text-background scroll-mt-24'>
      <div className='container'>
        ...
        >
          <TitleSection title={t('stats.title')} />
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8'>
          {stats.map((stat, index) => (
            ...
            >
              <div className={cn('size-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform', stat.bgColor)}>
        ...
        >
          <div className='flex items-center gap-3'>
            ...
            <div>
              <p className='font-semibold text-background'>{t('stats.badge1.title')}</p>
              <p className='text-sm text-background/60'>{t('stats.badge1.subtitle')}</p>
            </div>
          </div>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              <p className='font-semibold text-background'>{t('stats.badge2.title')}</p>
              <p className='text-sm text-background/60'>{t('stats.badge2.subtitle')}</p>
            </div>
          </div>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              <p className='font-semibold text-background'>{t('stats.badge3.title')}</p>
              <p className='text-sm text-background/60'>{t('stats.badge3.subtitle')}</p>
            </div>
          </div>
        </motion.div>
      </div>
